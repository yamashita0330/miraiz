        ...
        <div className="px-6 py-6">
          ...
          {partner.bio && (
            <div className="mb-5 rounded-2xl border border-border bg-muted/30 px-4 py-3">
              ...
              <p className="text-xs leading-relaxed">{partner.bio}</p>
            </div>
          )}
            ...
            <>
              ...
              <div className="mb-5 flex flex-col gap-2">
                ...
                {partner.personality_tags && partner.personality_tags.length > 0 && (
                  <div>
                    <p className="mb-1.5 text-[10px] text-muted-foreground">パーソナリティ</p>
...
function InfoCell({
  ...
  return (
    ...
    >
      ...
      <p className={cn('mt-1 text-xs font-medium', match && 'text-rose')}>{value}</p>
    </div>
  );
}
...
function InfoRow({
  ...
  return (
    ...
    >
      <span className={cn('text-[10px]', accent ? 'text-rose' : 'text-muted-foreground')}>
        {label}
      </span>
      <span className={cn('text-xs font-medium flex items-center gap-1', accent && 'text-rose')}>
        {value}
        {match && (
